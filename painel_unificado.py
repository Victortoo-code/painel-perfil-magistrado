...
st.title("📊 Painel de Perfil de Magistrado Unificado")
...
uploaded_file = st.file_uploader("📎 Envie a planilha de decisões (.xlsx)", type=".csv")
...
if uploaded_file:
    ...
    if aba == "👤 Análise Individual":
        ...
        juiz1 = st.selectbox("Juiz 1:", juizes, key="j1")
        juizes2 = [j for j in juizes if j != juiz1]
        juiz2 = st.selectbox("Juiz 2:", juizes2, key="j2")
